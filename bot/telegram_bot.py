...
WELCOME_TEXT = (
    "Привет! Я специалист по истории Великой Отечественной войны 🇷🇺\n\n"
    "Могу отвечать на вопросы о событиях войны, датах, "
    "ключевых сражениях, операциях и других важных фактах 📚\n\n"
    "Также могу отвечать на вопросы по следующим темам:\n\n"
    ...
    "Если нужно уточнить что-то по предыдущему ответу, просто спросите.\n\n"
